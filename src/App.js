...
import AddProjectFormik from './pages/project/AddProjectFormik';
    ...
    <BrowserRouter history={createBrowserHistory()}>
      <Routes>
        ...
        <Route path='/about' exact element={
          // <ErrorBoundary>
            <About name="Tommy" surname={11} age={23}/>
          // </ErrorBoundary>
        } ></Route>
        ...
        <Route path='/addProject' exact element={<AddProjectFormik />} ></Route>
